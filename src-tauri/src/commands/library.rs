...
#[tauri::command]
pub fn list_models(prefs: State<'_, AppPrefs>) -> Result<LibraryIndex, String> {
    let lib = prefs
        .library_folder
        .as_ref()
...
#[tauri::command]
pub fn library_stats(prefs: State<'_, AppPrefs>) -> Result<crate::models::LibraryTotals, String> {
