# 11f8eef0-afc3-4cb5-9577-2ad38acf8000 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `printables-offline-2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `printables-offline-2.html`
...
- A single self-contained `printables-offline-2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `printables-offline-2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `printables-offline-2.html`
- `printables-offline-3.html`
- `printables-offline-4.html`
- `printables-offline.html`
...
1. Inspect `printables-offline-2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
